...
<template>
  <div id="how-it-works" class="flex flex-col items-center justify-start gap-x-24 lg:flex-row scroll-mt-16">
    <div class="flex w-full flex-col gap-y-24 lg:w-1/2">
      <div class="flex flex-col gap-y-2">
        ...
        <p class="text-gray-700 dark:text-gray-200 text-lg font-normal">
          ...
          >
            LangGraph
            <UIcon name="i-mdi-launch" class="inline-block align-middle" aria-hidden="true" />
          </a>
